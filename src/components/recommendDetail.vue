   ...
   <section id="selectBox" v-show='selectShow'>
     <div class="chooseArea">
       ...
       <ul class="fieldBox clrfix">
         <li @click="selectField(fieldItem,index)"class="fieldItem" v-for="(fieldItem,index) in fieldItems" :class="{active:fieldActive == index}">{{fieldItem.fieldName}}</li>
       </ul>
     </div>
   </section>
     ...
     <ul class="contentMain">
       <li class="contentItem" v-for="(recommendItem,index) in recommendItems">
         ...
         <ul class="userBtns clrfix">
           ...
           <li @click="recommend(recommendItem,index)" :class="{active:recommendItem.recommendActive}"><span class="iconfont icon-recommendBtn"></span><span class="word">推荐</span></li>
           <li><span class="iconfont icon-share"></span><span class="word">分享</span></li>
           <li @click="collect(recommendItem,index)" :class="{active:recommendItem.collectActive}"><span class="iconfont icon-collect"></span><span class="collectWord word">收藏</span></li>
         </ul>
       </li>
     </ul>
   </section>
