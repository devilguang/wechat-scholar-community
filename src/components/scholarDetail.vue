<template>
  <div id="scholarDetail">
    ...
    <article class="tabBox">
      ...
      <!-- 选项卡部分页面在component体现 -->
      <component :is='currentView' keep-alive :infos="infos" :partnerItems="partnerItems" :instituteItems="instituteItems"></component>
    </article>
...
export default {
  ...
  mounted() {
    this.$http.get('/v1/scholar/' + this.$route.params.scholarUnique, {})
      .then((response) => {
